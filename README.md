...
Скрипт для автоматического добавления IP в листы Winbox MikroTik через API.
...
```
### mikrocat.service
Автоподнятие сервиса.
Просмотр логов в реальном времени после автоматического поднятия сервиса: 
```
sudo journalctl -u mikrocat -f
```
